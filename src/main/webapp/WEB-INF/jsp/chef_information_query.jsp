...
<div class="mainmessage">
  <div class="am-g ">
    ...
    <div class="am-u-lg-10" style="margin-bottom: 250px;">
        <h3 class="about-title about-color">厨师信息-查看</h3>
        <hr>
      <div class="am-center" style="width: 600px">
      <form class="am-form">
        <label for="chefId" class="about-color">厨师ID：</label>
        <input id="chefId" name="chefId" type="text" value=${chef.chefId} readonly>
        <br/>
        <label for="chefName" class="about-color">厨师姓名：</label>
        <input id="chefName" name="chefName" type="text"  value=${chef.chefName} readonly>
        <br/>

        <label for="chefPhone" class="about-color">手机号码：</label>
        <input id="chefPhone" name="chefPhone" type="tel" value=${chef.chefPhone}  readonly>
        <br/>
        <label for="chefChef" class="about-color">擅长菜系：</label>
        <input id="chefChef" name="chefChef" type="text" value=${chef.chefCaixi}  readonly>
        <br/>
        <center>
          <a href="/chef/chefInfomationUpdate"><button type="button" class="am-btn am-btn-danger am-btn-sm am-round"><i class="am-icon-check"></i> 修改信息</button</a>
        </center>
      </form>
      </div>
    </div>
