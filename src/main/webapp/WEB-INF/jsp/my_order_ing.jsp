    ...
    <div class="am-u-lg-9" style="margin-bottom: 250px;">
      ...
      <div>
        <table class="am-table am-table-striped am-table-hover table-main">
          <thead>
          <tr>
            <th class="table-id">订单id</th><th class="table-type">创建时间</th><th class="table-set">操作</th>
          </tr>
          </thead>
          <tbody>
          ...
          <tr>
            ...
            <td class="am-hide-sm-only">${order.orderTimeCreate}</td>
            <td>
              <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                  <a href="${path}/order/toOrderDetail?id=${order.orderId}"><button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 查看</button></a>

                  <a href="<%=appPath%>/order/pay/${order.orderId}"><button class="am-btn am-btn-default am-btn-xs am-text-success"><span class="am-icon-pencil-square-o"></span> 支付</button></a>

                  <a href="<%=appPath%>/order/del/${order.orderId}"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button></a>
