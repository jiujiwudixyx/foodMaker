...
<div class="mainmessage">
    <div class="am-g ">
        ...
        <div class="am-u-lg-10" style="margin-bottom: 250px;">
            <h3 class="about-title about-color">用户管理</h3>
            <hr>
            <div>
                    ...
                    <c:forEach var="user" items="${requestScope.get('list')}" varStatus="status">
                        ...
                        <tr>
                            ...
                            <td>
                                            ...
                                            <a href="<%=appPath%>/user/del/${user.userId}"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button></a>
