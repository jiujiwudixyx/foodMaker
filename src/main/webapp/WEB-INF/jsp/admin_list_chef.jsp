...
<div class="mainmessage">
    <div class="am-g ">
        ...
        <div class="am-u-lg-10" style="margin-bottom: 250px;">
            <h3 class="about-title about-color">厨师管理</h3>
            <hr>
            <div>
                <table class="am-table am-table-striped am-table-hover table-main">
                    <thead>
                    <tr>
                        <th class="table-id">厨师id</th>
                        <th>厨师姓名</th>
                        <th>厨师密码</th>
                        <th>手机号</th>
                        <th>擅长菜系</th>
                    ...
                    <tbody>
                    <c:forEach var="chef" items="${requestScope.get('list')}" varStatus="status">
                        ...
                        <tr>
                            ...
                            <td>${chef.chefId}</td>
                            <td>${chef.chefName}</td>
                            <td>${chef.chefPassWord}</td>
                            <td>${chef.chefPhone}</td>
                            <td>${chef.chefCaixi}</td>
                            <td>${chef.chefMoney}</td>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                            ...
                                            <a href="<%=appPath%>/chef/delChef/${chef.chefId}"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button></a>
