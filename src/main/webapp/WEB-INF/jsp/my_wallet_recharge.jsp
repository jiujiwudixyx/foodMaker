...
<div class="mainmessage">
  <div class="am-g am-container">
    ...
    <div class="am-u-lg-9" style="margin-bottom: 250px;">
        <h3 class="about-title about-color">我的钱包-充值</h3>
        <hr>
      <br>
      <form class="am-form">
        <center>
        <div class="am-btn-group doc-js-btn-1" data-am-button>
          <label class="am-btn am-btn-default am-btn-xl">
            <input type="radio" name="options" value="选项 1" id="option1"> 50 元
          </label>
          <label class="am-btn am-btn-default am-btn-xl">
            <input type="radio" name="options" value="选项 2" id="option2"> 100 元
          </label>
          <label class="am-btn am-btn-default am-btn-xl">
            <input type="radio" name="options" value="选项 3" id="option3"> 200 元
          </label>
        ...
        <br/>
          ...
          <br/>
          <br/>
          <button type="button" class="am-btn am-btn-success am-btn-xl am-round"><i class="am-icon-check"></i> 微信支付</button>

          <button type="button" class="am-btn am-btn-primary am-btn-xl am-round" ><i class="am-icon-check"></i> 支付宝支付</button>
        </center>
      </form>
    </div>
  </div>
