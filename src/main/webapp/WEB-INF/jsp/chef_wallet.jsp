...
<div class="mainmessage">
  <div class="am-g ">
    ...
    <div class="am-u-lg-10" style="margin-bottom: 250px;">
      <h3 class="about-title about-color">我的钱包</h3>
      <hr>
      <center>
        <p>余额<span style="font-size: 30px;color: #f52727;"> 200 </span>元</p>
       <br>
        <button type="button" class="am-btn am-btn-danger am-btn-xl am-round"><i class="am-icon-check"></i> 提现至银行卡</button>

        <button type="button" class="am-btn am-btn-success am-btn-xl am-round" ><i class="am-icon-check"></i> 提现至微信</button>
        <button type="button" class="am-btn am-btn-primary am-btn-xl am-round" ><i class="am-icon-check"></i> 提现至支付宝</button>
      </center>
    </div>
  </div>
</div>
