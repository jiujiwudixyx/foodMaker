...
<div class="about">
  <div class="am-g am-container">
    <div class="am-u-lg-12">
      <h3 class="about-title about-color">管理员登录</h3>
        ...
        <div class="am-center" style="width: 536px;">
          <form class="am-form">
            ...
            <label for="adminPhone" class="about-color">手机号：</label>
            <input id="adminPhone"  name="adminPhone" type="text">
            <br/>
            <label for="adminPassWord" class="about-color">密码：</label>
