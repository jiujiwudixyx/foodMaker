...
<div class="mainmessage">
  <div class="am-g ">
    ...
    <div class="am-u-lg-10" style="margin-bottom: 250px;">
      <h3 class="about-title about-color">待接单订单</h3>
      <hr>
      <div>
            ...
            <td>
              <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                  <a href="${path}/order/toOrderDetail1?id=${order.orderId}"><button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 查看</button></a>

                  <a href="<%=appPath%>/order/del1/${order.orderId}"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button></a>
                </div>
              </div>
            </td>
          </tr>
