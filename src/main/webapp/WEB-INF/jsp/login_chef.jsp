...
<div class="about">
  <div class="am-g am-container">
    <div class="am-u-lg-12">
      <h3 class="about-title about-color">厨师登录</h3>
        ...
        <div class="am-center" style="width: 536px;">
          <form class="am-form">
            ...
            <label for="chefPhone" class="about-color">手机号：</label>
            <input id="chefPhone"  name="chefPhone" type="text">
            <br/>
