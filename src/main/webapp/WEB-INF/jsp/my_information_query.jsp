...
<div class="mainmessage">
  <div class="am-g am-container">
    ...
    <div class="am-u-lg-9" style="margin-bottom: 250px;">
        <h3 class="about-title about-color">我的信息</h3>
        <hr>
      <form class="am-form">
        <label for="userId" class="about-color">用户ID：</label>
        <input id="userId"  name="userId" type="text" value=${user.userId} readonly>
        <br/>
        ...
        <input id="userPhone" name="userPhone" type="tel" value=${user.userPhone}  readonly>
        <br/>
<center>
         <a href="/user/myInfomationUpdate"><button type="button" class="am-btn am-btn-danger am-btn-sm am-round"><i class="am-icon-check"></i> 修改信息</button</a>
          </center>
      </form>
    </div>
  </div>
