      ...
      <div class="am-center" style="width: 536px;">
        <form class="am-form">
          ...
          <center>
            ...
            <br/>
            <a href="${path}/order/toUpdateOrder?id=${order.orderId}"><button type="button" class="am-btn am-btn-warning am-btn-xl am-round" style="width: 200px;"><i class="am-icon-warning"></i> 修 改</button></a>
            <a href="${path}/order/allOrder8"><button type="button" class="am-btn am-btn-primary am-btn-xl am-round" style="width: 200px;"><i class="am-icon-check"></i> 返 回</button></a>
            <br/>
