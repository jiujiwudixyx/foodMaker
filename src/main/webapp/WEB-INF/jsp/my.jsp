...
<div class="mainmessage">
  <div class="am-g am-container">
    ...
    <div class="am-u-lg-9" style="margin-bottom: 250px;">
        <h3 class="about-title about-color">总览</h3>
        <hr>
        <center>
        <p>未完成订单<span style="font-size: 30px;color: #f52727;"> 1 </span>笔</p>
        <p>已完成订单<span style="font-size: 30px;color: #24f528;"> 19 </span>笔</p>
        </center>
    </div>
  </div>
</div>
