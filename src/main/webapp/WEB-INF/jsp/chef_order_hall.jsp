...
<div class="mainmessage">
    <div class="am-g ">
        ...
        <div class="am-u-lg-10" style="margin-bottom: 250px;">
            <h3 class="about-title about-color">订单大厅</h3>
            <hr>
            <div>
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <c:forEach var="order" items="${requestScope.get('list')}" varStatus="status">
                        <tr>
                            ...
                            <td>${order.orderCaixi} ${order.orderTaocan}</td>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        ...
                                        <a href="<%=appPath%>/order/chefGet/${order.orderId}">
                                            <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                                <span class="am-icon-trash-o"></span> 接单
                                            </button>
                                        </a>
                                    </div>
                                </div>
